...
data class SimulationSummaryEntry(
    ...
    val averageMaxVelocity: Double = 0.0,
    val maxMaxVelocity: Double = 0.0,
    val minMaxVelocity: Double = 0.0,
    val averageSpurtDistance: Double = 0.0,
    val maxSpurtDistance: Double = 0.0,
    val minSpurtDistance: Double = 0.0,
    val staminaDepletionCount: Int = 0,
    val averageStaminaDepletionDistance: Double = 0.0,
    val longestStaminaDepletionDistance: Double = 0.0,
    val shortestStaminaDepletionDistance: Double = 0.0,
